            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {geoLoading
                  ? "..."
                  : geoSummary?.reduce(
                      (sum: number, item: { visitor_count: number }) =>
                        sum + item.visitor_count,
                      0
                    ) || 0}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-2xl font-bold">
                {geoLoading
                  ? "..."
                  : geoSummary?.reduce(
                      (sum: number, item: { page_views: number }) =>
                        sum + item.page_views,
                      0
                    ) || 0}
              </p>
          ...
          {vpnStats.total_vpn_visits_today > 0 ? (
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <p className="text-sm text-blue-800">
                ...
                {vpnStats.total_vpn_visits_today} VPN visits detected today (
                {vpnStats.vpn_percentage}% of total traffic) from{" "}
                {vpnStats.unique_vpn_ips_today} unique IPs.
      ...
      <Card className="p-6">
        ...
        {visitorsLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-sm">
              Visitors are considered active if they&apos;ve been on the site in
              the last 10 minutes
            </p>
          </div>
        )}
...
export default LiveVisitorMonitor;
