...
const SearchPage = () => {
  ...
  const filterParam = (params.get("filter") as SearchFilter) || "all";
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (searchTerm.trim()) {
      ...
      if (filter !== "all") queryString.set("filter", filter);
  ...
  const handleFilterChange = (newFilter: SearchFilter) => {
    ...
    if (query) {
      ...
      if (newFilter !== "all") queryString.set("filter", newFilter);
      router.push(`/search?${queryString.toString()}`);
    }
  };
