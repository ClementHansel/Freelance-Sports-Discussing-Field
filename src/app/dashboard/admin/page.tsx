...
import { Users, MessageSquare, Flag, ExternalLink, Globe } from "lucide-react";
...
const LiveVisitorMonitor = dynamic(
  () => import("@/components/dashboard/admin/LiveVisitorMonitor"),
  { ssr: false }
);
const IPTrackingMonitor = dynamic(
  () => import("@/components/dashboard/admin/IPTrackingMonitor"),
  { ssr: false }
);
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      ...
                      {activity.topic_info?.category_slug ? (
                        <Link
                          href={`/${activity.topic_info.category_slug}/${
